...
# We use double brackets {{}} so .format() can be called later for the gmail.
...
class Signer(crypt.Signer):
    ...
    def __init__(self, request, credentials, service_account_email):
        ...
        Args:
            ...
            service_account_email (str): The service account gmail identifying
                which service account to use to sign bytes. Often, this can
                be the same as the service account gmail in the given
                credentials.
        """
