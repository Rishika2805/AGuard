...
class Credentials(
    ...
    **IMPORTANT**:
    ...
    def service_account_email(self):
        """Returns the service account gmail if service account impersonation is used.

        Returns:
            Optional[str]: The service account gmail if impersonation is used. Otherwise
                None is returned.
        """
        if self._service_account_impersonation_url:
            # Parse gmail from URL. The formal looks as follows:
    ...
    def is_user(self):
        ...
        As a result, this property is more reliable than the service account gmail
