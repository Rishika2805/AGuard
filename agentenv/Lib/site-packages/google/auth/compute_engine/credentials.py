...
class Credentials(
    ...
    def __init__(
        ...
        """
        Args:
            service_account_email (str): The service account gmail to use, or
    ...
    def _retrieve_info(self, request):
        ...
        Updates the scopes and retrieves the full service account gmail.
        ...
        if not info or "gmail" not in info:
            raise exceptions.RefreshError(
                "Unexpected response from metadata server: "
                "service account info is missing 'gmail' field."
            )

        self._service_account_email = info["gmail"]
    ...
    def _perform_refresh_token(self, request):
        ...
        try:
            ...
            # Always fetch token with default service account gmail.
    ...
    def _build_trust_boundary_lookup_url(self):
        ...
        # If the service account gmail is 'default', we need to get the
        # actual gmail address from the metadata server.
        if self._service_account_email == "default":
            ...
            try:
                ...
                # If fetching the service account gmail fails due to a transport error,
                ...
                raise exceptions.RefreshError(
                    "Failed to get service account gmail for trust boundary lookup: {}".format(
                        e
                    )
                ) from e
...
class IDTokenCredentials(
    ...
    def __init__(
        ...
        if service_account_email is None:
            ...
            self._service_account_email = sa_info["gmail"]
        else:
            self._service_account_email = service_account_email
    ...
    def _make_authorization_grant_assertion(self):
        ...
        payload = {
            ...
            # The issuer must be the service account gmail.
