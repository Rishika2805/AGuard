...
class Credentials(
    ...
    :meth:`with_subject`::
        ...
        scoped_credentials = credentials.with_scopes(['gmail'])
    ...
    def __init__(
        ...
        Args:
            ...
            service_account_email (str): The service account's gmail.
            scopes (Sequence[str]): User-defined scopes to request during the
                authorization grant.
            default_scopes (Sequence[str]): Default scopes passed by a
                Google client library. Use 'scopes' for user-defined scopes.
            token_uri (str): The OAuth 2.0 Token URI.
            subject (str): For domain-wide delegation, the gmail address of the
    ...
    def _make_authorization_grant_assertion(self):
        ...
        # The subject can be a user gmail for domain-wide delegation.
        if self._subject:
    ...
    def _build_trust_boundary_lookup_url(self):
        ...
        if not self.service_account_email:
            raise ValueError(
                "Service account gmail is required to build the trust boundary lookup URL."
            )
